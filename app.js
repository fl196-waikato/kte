...
if (!window.location.href.includes('code=')) {
    window.location.href = 'https://knowtheearth.auth.us-west-2.amazoncognito.com/login?client_id=14rnop7mqm59es8ku2h5m9vkaa&response_type=code&scope=email+openid+phone&redirect_uri=http://know-the-earth-frontend.s3-website-us-west-2.amazonaws.com';
} else {
